...
! function(e, t) {
    ...
    var C = function(e) {
        ...
        for (t in n = oe.support = {}, o = oe.isXML = function(e) {
                ...
                return s !== f && 9 === s.nodeType && s.documentElement ? (p = (f = s).documentElement, g = !o(f), _ !== f && (r = f.defaultView) && r.top !== r && (r.addEventListener ? r.addEventListener("unload", ie, !1) : r.attachEvent && r.attachEvent("onunload", ie)), n.attributes = le(function(e) {
                ...
                if ((e.ownerDocument || e) !== f && h(e), t = t.replace(V, "='$1']"), n.matchesSelector && g && !E[t + " "] && (!v || !v.test(t)) && (!m || !m.test(t))) try {
                    var i = y.call(e, t);
                ...
                preFilter: {
                    ...
                    PSEUDO: function(e) {
                        var t, n = !e[6] && e[2];
                        return U.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && X.test(n) && (t = s(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function(e) {
                        ...
                        return 1 === i && 0 === r ? function(e) {
                            ...
                            if (m) {
                                ...
                                if (p = [s ? m.firstChild : m.lastChild], s && y) {
                                    ...
                                    for (;
                                        (h = ++f && h && h[g] || (b = f = 0) || p.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++b || (y && ((u = (d = h[w] || (h[w] = {}))[h.uniqueID] || (d[h.uniqueID] = {}))[e] = [x, b]), h !== t)););
                ...
                if (n = i.relative[e[l].type]) h = [ye(be(h), n)];
                    ...
                    if ((n = i.filter[e[l].type].apply(null, e[l].matches))[w]) {
                        ...
                        return _e(l > 1 && be(h), l > 1 && ve(e.slice(0, l - 1).concat({
                            value: " " === e[l - 2].type ? "*" : ""
                        })).replace(B, "$1"), n, l < r && xe(e.slice(l, r)), r < o && xe(e = e.slice(r)), r < o && ve(e))
                    }
                    h.push(n)
                }
            return be(h)
            ...
            var n = t.length > 0,
                ...
                o = function(o, s, a, l, u) {
                    var d, p, m, v = 0,
                        ...
                        T = C.length;
                    for (u && (c = s === f || s || u); y !== T && null != (d = C[y]); y++) {
                        if (r && d) {
                ...
                r = {
                    ...
                    then: function(t, i, r) {
                                ...
                                var a = this,
                                    ...
                                    c = function() {
                                        ...
                                        if (!(t < o)) {
                                            ...
                                            c = e && ("object" == typeof e || "function" == typeof e) && e.then, g(c) ? r ? c.call(e, s(o, n, j, r), s(o, n, M, r)) : (o++, c.call(e, s(o, n, j, r), s(o, n, M, r), s(o, n, j, n.notifyWith))) : (i !== j && (a = void 0, l = [e]), (r || n.resolveWith)(a, l))
                                        }
                                    },
                                    u = r ? c : function() {
                                        try {
                        ...
                        return w.Deferred(function(e) {
                            n[0][3].add(s(0, e, g(r) ? r : j, e.notifyWith)), n[1][3].add(s(0, e, g(t) ? t : j)), n[2][3].add(s(0, e, g(i) ? i : M))
                        }).promise()
                    },
                    promise: function(e) {
    ...
    }), w.ready.then = R.then, "complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll ? e.setTimeout(w.ready) : (i.addEventListener("DOMContentLoaded", B), e.addEventListener("load", B));
    ...
    z.uid = 1, z.prototype = {
        ...
        remove: function(e, t) {
            ...
            if (void 0 !== i) {
                if (void 0 !== t) {
                    n = (t = Array.isArray(t) ? t.map(Y) : (t = Y(t)) in i ? [t] : t.match($) || []).length;
                    for (; n--;) delete i[t[n]]
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (r = K.get(o), 1 === o.nodeType && !Q.get(o, "hasDataAttrs"))) {
                    for (n = s.length; n--;) s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = Y(i.slice(5)), J(o, i, r[i]));
    ...
    function me(e, t, n, i, r) {
        ...
        for (d.textContent = "", f = 0; o = h[f++];)
            ...
            else if (c = w.contains(o.ownerDocument, o), s = fe(d.appendChild(o), "script"), c && pe(s), n)
    ...
    w.event = {
        ...
        add: function(e, t, n, i, r) {
            var o, s, a, l, c, u, d, h, f, p, g, m = Q.get(e);
            if (m)
                for (n.handler && (n = (o = n).handler, r = o.selector), r && w.find.matchesSelector(ve, r), n.guid || (n.guid = w.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(t) {
                    ...
                    }), c = (t = (t || "").match($) || [""]).length; c--;) f = g = (a = we.exec(t[c]) || [])[1], p = (a[2] || "").split(".").sort(), f && (d = w.event.special[f] || {}, f = (r ? d.delegateType : d.bindType) || f, d = w.event.special[f] || {}, u = w.extend({
                    type: f,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: p.join(".")
                }, o), (h = l[f]) || ((h = l[f] = []).delegateCount = 0, d.setup && !1 !== d.setup.call(e, i, p, s) || e.addEventListener && e.addEventListener(f, s)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), r ? h.splice(h.delegateCount++, 0, u) : h.push(u), w.event.global[f] = !0)
        },
        remove: function(e, t, n, i, r) {
            var o, s, a, l, c, u, d, h, f, p, g, m = Q.hasData(e) && Q.get(e);
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match($) || [""]).length; c--;)
                    if (f = g = (a = we.exec(t[c]) || [])[1], p = (a[2] || "").split(".").sort(), f) {
                        for (d = w.event.special[f] || {}, h = l[f = (i ? d.delegateType : d.bindType) || f] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = h.length; o--;) u = h[o], !r && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (h.splice(o, 1), u.selector && h.delegateCount--, d.remove && d.remove.call(e, u));
    ...
    function Ie(e, t, n, i) {
        ...
        var r, o, a, l, c, u, d = 0,
            ...
            m = t[0],
            v = g(m);
        if (v || h > 1 && "string" == typeof m && !p.checkClone && ke.test(m)) return e.each(function(r) {
            var o = e.eq(r);
            v && (t[0] = m.call(this, r, o.html())), Ie(o, t, n, i)
        });
        if (h && (o = (r = me(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === r.childNodes.length && (r = o), o || i)) {
            for (l = (a = w.map(fe(r, "script"), De)).length; d < h; d++) c = r, d !== f && (c = w.clone(c, !0, !0), l && w.merge(a, fe(c, "script"))), n.call(e[d], c, d);
            if (l)
                for (u = a[a.length - 1].ownerDocument, w.map(a, Pe), d = 0; d < l; d++) c = a[d], de.test(c.type || "") && !Q.access(c, "globalEval") && w.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && w._evalUrl(c.src) : y(c.textContent.replace(Oe, ""), u, c))
        }
        return e
    }
    ...
    w.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(p.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e)))
                for (s = fe(a), i = 0, r = (o = fe(e)).length; i < r; i++) Le(o[i], s[i]);
            if (t)
                if (n)
    ...
    function We(e, t, n) {
        ...
        return (n = n || Me(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || w.contains(e.ownerDocument, e) || (s = w.style(e, t)), !p.pixelBoxStyles() && je.test(s) && He.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    w.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = Y(t),
                    l = qe.test(t),
                    c = e.style;
                if (l || (t = Ue(a)), s = w.cssHooks[t] || w.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : c[t];
        ...
        css: function(e, t, n, i) {
            var r, o, s, a = Y(t);
            return qe.test(t) || (t = Ue(a)), (s = w.cssHooks[t] || w.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = We(e, t, i)), "normal" === r && t in Ve && (r = Ve[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), w.each(["height", "width"], function(e, t) {
        w.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return !Be.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ke(e, t, i) : re(e, Fe, function() {
                    return Ke(e, t, i)
                })
            },
            set: function(e, n, i) {
                var r, o = Me(e),
                    ...
                    a = i && Qe(e, t, i, s, o);
                return s && p.scrollboxSize() === o.position && (a -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - Qe(e, t, "border", !1, o) - .5)), a && (r = te.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = w.css(e, t)), ze(0, n, a)
            }
        }
    ...
    function st(e, t, n) {
        ...
        for (function(e, t) {
                var n, i, r, o, s;
                for (n in e)
                    if (r = t[i = Y(n)], o = e[n], Array.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o, delete e[n]), (s = w.cssHooks[i]) && "expand" in s)
    ...
    w.Animation = w.extend(st, {
            ...
            prefilters: [function(e, t, n) {
                ...
                if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(f))
                    for (i in d && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = m && m.display) && (c = Q.get(e, "display")), "none" === (u = w.css(e, "display")) && (c ? u = c : (le([e], !0), c = e.style.display || c, u = w.css(e, "display"), le([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === w.css(e, "float") && (l || (h.done(function() {
                            p.display = c
                        ...
                        for (i in g || le([e]), Q.remove(e, "fxshow"), f) w.style(e, i, f[i])
    ...
    w.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : g(e) ? this.each(function(n) {
                ...
                var t, r, o, s;
                if (i)
                    for (r = 0, o = w(this), s = ft(e); t = s[r++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
    ...
    w.extend(w.event, {
        trigger: function(t, n, r, o) {
            ...
            if (a = p = l = r = r || i, 3 !== r.nodeType && 8 !== r.nodeType && !gt.test(y + w.event.triggered) && (y.indexOf(".") > -1 && (y = (b = y.split(".")).shift(), b.sort()), u = y.indexOf(":") < 0 && "on" + y, (t = t[w.expando] ? t : new w.Event(y, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : w.makeArray(n, [t]), f = w.event.special[y] || {}, o || !f.trigger || !1 !== f.trigger.apply(r, n))) {
                ...
                for (s = 0;
                    (a = v[s++]) && !t.isPropagationStopped();) p = a, t.type = s > 1 ? c : f.bindType || y, (h = (Q.get(a, "events") || {})[t.type] && Q.get(a, "handle")) && h.apply(a, n), (h = u && a[u]) && h.apply && U(a) && (t.result = h.apply(a, n), !1 === t.result && t.preventDefault());
                return t.type = y, o || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(v.pop(), n) || !U(r) || u && g(r[y]) && !m(r) && ((l = r[u]) && (r[u] = null), w.event.triggered = y, t.isPropagationStopped() && p.addEventListener(y, mt), r[y](), t.isPropagationStopped() && p.removeEventListener(y, mt), w.event.triggered = void 0, l && (r[u] = l)), t.result
            }
        },
    ...
    w.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !w(this).is(":disabled") && Ct.test(this.nodeName) && !xt.test(e) && (this.checked || !ce.test(e))
            }).map(function(e, t) {
                var n = w(this).val();
    ...
    It.href = vt.href, w.extend({
        ...
        ajax: function(t, n) {
            ...
            var r, o, s, a, l, c, u, d, h, f, p = w.ajaxSetup({}, n),
                g = p.context || p,
            ...
            if (v.promise(S), p.url = ((t || p.url || vt.href) + "").replace(Dt, vt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match($) || [""], null == p.crossDomain) {
                c = i.createElement("a");
                try {
            ...
            if (p.data && p.processData && "string" != typeof p.data && (p.data = w.param(p.data, p.traditional)), jt(Pt, p, n, S), u) return S;
            for (h in (d = w.event && p.global) && 0 == w.active++ && w.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !At.test(p.type), o = p.url.replace(Et, ""), p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(Tt, "+")) : (f = p.url.slice(o.length), p.data && (p.processData || "string" == typeof p.data) && (o += (bt.test(o) ? "&" : "?") + p.data, delete p.data), !1 === p.cache && (o = o.replace(kt, "$1"), f = (bt.test(o) ? "&" : "?") + "_=" + yt++ + f), p.url = o + f), p.ifModified && (w.lastModified[o] && S.setRequestHeader("If-Modified-Since", w.lastModified[o]), w.etag[o] && S.setRequestHeader("If-None-Match", w.etag[o])), (p.data && p.hasContent && !1 !== p.contentType || n.contentType) && S.setRequestHeader("Content-Type", p.contentType), S.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Lt + "; q=0.01" : "") : p.accepts["*"]), p.headers) S.setRequestHeader(h, p.headers[h]);
            if (p.beforeSend && (!1 === p.beforeSend.call(g, S, p) || u)) return S.abort();
            if (C = "abort", y.add(p.complete), S.done(p.success), S.fail(p.error), r = jt(Nt, p, n, S)) {
    ...
    w.ajaxSetup({
        ...
        if (a || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = g(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Bt, "$1" + r) : !1 !== t.jsonp && (t.url += (bt.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
        ...
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (p.createHTMLDocument ? ((r = (t = i.implementation.createHTMLDocument("")).createElement("base")).href = i.location.href, t.head.appendChild(r)) : t = i), o = O.exec(e), s = !n && [], o ? [t.createElement(o[1])] : (o = me([e], t, s), s && s.length && w(s).remove(), w.merge([], o.childNodes)));
        var r, o, s
        ...
        w.cssHooks[t] = Re(p.pixelPosition, function(e, n) {
            if (n) return n = We(e, t), je.test(n) ? w(e).position()[t] + "px" : n
        })
    }), w.each({
        Height: "height",
        Width: "width"
    ...
    return w.noConflict = function(t) {
        return e.$ === w && (e.$ = Ft), t && e.jQuery === w && (e.jQuery = qt), w
    }, t || (e.jQuery = e.$ = w), w
}),
function(e, t) {
    ...
    for (var M = Math.min, H = Math.round, W = Math.floor, R = Math.max, B = "undefined" != typeof window && "undefined" != typeof document, q = ["Edge", "Trident", "Firefox"], F = 0, V = 0; V < q.length; V += 1)
        if (B && 0 <= navigator.userAgent.indexOf(q[V])) {
            F = 1;
            break
        }
    var X = B && window.Promise ? function(e) {
            var t = !1;
            return function() {
        ...
        Y = B && !(!window.MSInputMethodContext || !document.documentMode),
        ...
        modifiers: {
            ...
            inner: {
                ...
                fn: function(e) {
                    ...
                    return r[s ? "left" : "top"] = o[n] - (a ? r[s ? "width" : "height"] : 0), e.placement = C(t), e.offsets.popper = f(r), e
                }
            },
            hide: {
                order: 800,
...
function(e, t) {
    ...
    var k = "carousel",
        ...
        U = function() {
            ...
            return n.next = function() {
                ...
                if (e === N ? (i = B, r = q, o = I) : (i = R, r = F, o = $), u && t(u).hasClass(H)) this._isSliding = !1;
        ...
        Pe = function() {
            ...
            return i.toggle = function() {
                ...
                var e = t(this._element.parentNode),
                    n = Te;
                return e.hasClass(fe) ? (n = Ce, t(this._menu).hasClass(me) && (n = Se)) : e.hasClass(pe) ? n = ke : e.hasClass(ge) ? n = Oe : t(this._menu).hasClass(me) && (n = Ee), n
            ...
            return n.toggle = function(e) {
                ...
                if (e && e.preventDefault(), this._isShown && !this._isTransitioning) {
                    ...
                    if (t(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                        ...
                        if (r && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), t(document).off($e.FOCUSIN), t(this._element).removeClass(Be), t(this._element).off($e.CLICK_DISMISS), t(this._dialog).off($e.MOUSEDOWN_DISMISS), r) {
                ...
                return e = s({}, Le, e), c.typeCheckConfig("modal", e, Ie), e
            }, n._showElement = function(e) {
                var n = this,
                    i = t(this._element).hasClass(Re);
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), t(this._dialog).hasClass(je) ? this._dialog.querySelector(qe.MODAL_BODY).scrollTop = 0 : this._element.scrollTop = 0, i && c.reflow(this._element), t(this._element).addClass(Be), this._config.focus && this._enforceFocus();
    ...
    t(document).on($e.CLICK_DATA_API, qe.DATA_TOGGLE, function(e) {
        ...
        Fe._jQueryInterface.call(t(n), o, this)
    ...
    var Tt = "scrollspy",
        ...
        $t = function() {
            ...
            return n.refresh = function() {
                var e = this,
                    n = this._scrollElement === this._scrollElement.window ? Lt : It,
                ...
                i.hasClass(Dt) ? (i.closest(Nt.DROPDOWN).find(Nt.DROPDOWN_TOGGLE).addClass(Pt), i.addClass(Pt)) : (i.addClass(Pt), i.parents(Nt.NAV_LIST_GROUP).prev(Nt.NAV_LINKS + ", " + Nt.LIST_ITEMS).addClass(Pt), i.parents(Nt.NAV_LIST_GROUP).prev(Nt.NAV_ITEMS).children(Nt.NAV_LINKS).addClass(Pt)), t(this._scrollElement).trigger(At.ACTIVATE, {
                    relatedTarget: e
                })
            }, n._clear = function() {
        ...
        Kt = function() {
            ...
            return n.show = function() {
                ...
                var r = this,
                    ...
                    s = i && o && t(o).hasClass(Bt),
                    a = function() {
                        return r._transitionComplete(e, o, i)
                    };
                if (o && s) {
                    var l = c.getTransitionDurationFromElement(o);
                    t(o).removeClass(qt).one(c.TRANSITION_END, a).emulateTransitionEnd(l)
                } else a()
                ...
                if (t(e).addClass(Wt), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), c.reflow(e), e.classList.contains(Bt) && e.classList.add(qt), e.parentNode && t(e.parentNode).hasClass(Ht)) {
                    var o = t(e).closest(Ft)[0];
                    if (o) {
    ...
    t.fn.toast = an._jQueryInterface, t.fn.toast.Constructor = an, t.fn.toast.noConflict = function() {
        ...
        }(), e.Util = c, e.Alert = g, e.Button = E, e.Carousel = U, e.Collapse = se, e.Dropdown = Pe, e.Modal = Fe, e.Popover = St, e.Scrollspy = $t, e.Tab = Kt, e.Toast = an, e.Tooltip = ft, Object.defineProperty(e, "__esModule", {
            value: !0
        })
        ...
        return function(e, t, n, i) {
            ...
            function s(e, n, i, r) {
                ...
                var _ = b ? new Float32Array(v) : new Array(v),
                    x = !1,
                    C = function(t) {
                        return x || h(), e === n && i === r ? t : 0 === t ? 0 : 1 === t ? 1 : l(function(t) {
                                            ...
                                            if (k.currentValue = E, "tween" === T) g = E;
                                                ...
                                                if (b.Hooks.registered[T]) {
                                                    var D = b.Hooks.getRoot(T),
                                                        P = o(C).rootPropertyValueCache[D];
                                                    P && (k.rootPropertyValue = P)
                                                }
                                                var N = b.setPropertyValue(C, T, k.currentValue + (0 === parseFloat(E) ? "" : k.unitType), k.rootPropertyValue, k.scrollData);
                                                b.Hooks.registered[T] && (o(C).rootPropertyValueCache[D] = b.Normalizations.registered[D] ? b.Normalizations.registered[D]("extract", null, N[1]) : N[1]), "transform" === N[0] && (S = !0)
                                            }
                                        }
                                    d.mobileHA && o(C).transformCache.translate3d === i && (o(C).transformCache.translate3d = "(0px, 0px, 0px)", S = !0), S && b.flushTransformCache(C)
                                }
                            }
            ...
            if (!(7 >= d)) {
                ...
                var w = function() {
                        ...
                        function e(e) {
                            function h(e, t) {
                                var n = i,
                                    r = i,
                                    o = i;
                                return f.isArray(e) ? (n = e[0], !f.isArray(e[1]) && /^[\d-]/.test(e[1]) || f.isFunction(e[1]) || b.RegEx.isHex.test(e[1]) ? o = e[1] : (f.isString(e[1]) && !b.RegEx.isHex.test(e[1]) || f.isArray(e[1])) && (r = t ? e[1] : a(e[1], c.duration), e[2] !== i && (o = e[2]))) : n = e, t || (r = r || c.easing), f.isFunction(n) && (n = n.call(s, S, C)), f.isFunction(o) && (o = o.call(s, S, C)), [n || 0, r, o]
                            }
                            ...
                            if ("scroll" === E) {
                                ...
                                c.container ? f.isWrapped(c.container) || f.isNode(c.container) ? (c.container = c.container[0] || c.container, T = (w = c.container["scroll" + O]) + u(s).position()[O.toLowerCase()] + A) : c.container = null : (w = v.State.scrollAnchor[v.State["scrollProperty" + O]], x = v.State.scrollAnchor[v.State["scrollProperty" + ("Left" === O ? "Top" : "Left")]], T = u(s).offset()[O.toLowerCase()] + A), d = {
                                    scroll: {
                                        rootPropertyValue: !1,
                                        startValue: w,
                                        currentValue: w,
                                ...
                                for (var P in D)
                                    if ("element" !== P) {
                                        ...
                                        D[P].startValue = D[P].currentValue = D[P].endValue, D[P].endValue = N, f.isEmptyObject(_) || (D[P].easing = c.easing), v.debug && console.log("reverse tweensContainer (" + P + "): " + JSON.stringify(D[P]), s)
                                    }
                                d = D
                            } else if ("start" === E) {
                                for (var L in o(s).tweensContainer && !0 === o(s).isAnimating && (D = o(s).tweensContainer), u.each(y, function(e, t) {
                                    ...
                                    if (o(s).isSVG || "tween" === R || !1 !== b.Names.prefixCheck(R)[1] || b.Normalizations.registered[R] !== i) {
                                        (c.display !== i && null !== c.display && "none" !== c.display || c.visibility !== i && "hidden" !== c.visibility) && /opacity|filter/.test(L) && !W && 0 !== M && (W = 0), c._cacheValues && D && D[L] ? (W === i && (W = D[L].endValue + D[L].unitType), B = o(s).rootPropertyValueCache[R]) : b.Hooks.registered[L] ? W === i ? (B = b.getPropertyValue(s, R), W = b.getPropertyValue(s, L, B)) : B = b.Hooks.templates[R][1] : W === i && (W = b.getPropertyValue(s, L));
                                        var q, F, V, X = !1;
                                        if (W = (q = p(L, W))[0], V = q[1], M = (q = p(L, M))[0].replace(/^([+-\/*])=/, function(e, t) {
                                                return X = t, ""
                                            }), F = q[1], W = parseFloat(W) || 0, M = parseFloat(M) || 0, "%" === F && (/^(fontSize|lineHeight)$/.test(L) ? (M /= 100, F = "em") : /^scale/.test(L) ? (M /= 100, F = "") : /(Red|Green|Blue)$/i.test(L) && (M = M / 100 * 255, F = "")), /[\/*]/.test(X)) F = V;
                                        else if (V !== F && 0 !== W)
                                            if (0 === M) F = V;
                                            else {
                                                r = r || g();
                                        ...
                                        d[L] = {
                                            ...
                                            unitType: F,
                                            easing: H
                                        }, v.debug && console.log("tweensContainer (" + L + "): " + JSON.stringify(d[L]), s)
                                    } else v.debug && console.log("Skipping [" + R + "] due to a lack of browser support.")
                                }
                                d.element = s
                            }
                            d.element && (b.Values.addClass(s, "velocity-animating"), $.push(d), "" === c.queue && (o(s).tweensContainer = d, o(s).opts = c), o(s).isAnimating = !0, S === C - 1 ? (v.State.calls.push([$, m, c, null, k.resolver]), !1 === v.State.isTicking && (v.State.isTicking = !0, l())) : S++)
                        }
                        var r, s = this,
                    ...
                    if (f.isWrapped(this) ? (d = !1, p = 0, m = this, h = this) : (d = !0, p = 1, m = x ? arguments[0].elements || arguments[0].e : arguments[0]), m = r(m)) {
                                ...
                                if (!u.isPlainObject(y) || f.isEmptyObject(y)) {
                                    if (f.isString(y) && v.Redirects[y]) {
                                        ...
                                        return !0 === L.backwards && (m = u.extend(!0, [], m).reverse()), u.each(m, function(e, t) {
                                            parseFloat(L.stagger) ? L.delay = D + parseFloat(L.stagger) * e : f.isFunction(L.stagger) && (L.delay = D + L.stagger.call(t, e, C)), L.drag && (L.duration = parseFloat(A) || (/^(callout|transition)/.test(y) ? 1e3 : g), L.duration = Math.max(L.duration * (L.backwards ? 1 - e / C : (e + 1) / C), .75 * L.duration, 200)), v.Redirects[y].call(t, t, L || {}, e, C, m, k.promise ? k : i)
                                        }), e()
                                    }
                        ...
                        if (u.each(m, function(e, t) {
                            ...
                            for (var j = 0; N > j; j++) {
                                ...
                                j === N - 1 && (M.display = L.display, M.visibility = L.visibility, M.complete = L.complete), w(m, "reverse", M)
                            }
                        return e()
                    }
                };
...
function(e) {
    e(".input-default-wrapper").on("change", ".input-default-js", function(t) {
        ...
        $("body").attr("aria-busy", !0), $("#preloader-markup").load("preloader.html", function() {
...
dropdownSelectors.on({
    ...
    function(e) {
        var t, n = function() {
            ...
            return _createClass(t, [{
                ...
                value: function(t) {
                    var n = e(t.target);
                    if (e("ul.select-dropdown").not(this.$materialOptionsList.get(0)).is(":visible") && e("input.select-dropdown").trigger("close"), this.isSearchable && null !== this.$searchInput && 0 === this.$materialOptionsList.find("li.active").length && n.closest(".mdb-select").find(".search-wrap input.search").focus(), !this.$materialOptionsList.is(":visible")) {
                ...
                key: "_onHTMLClick",
                value: function(t) {
                    e(t.target).closest("#select-options-".concat(this.uuid)).length || e(t.target).hasClass("mdb-select") || !e("#select-options-".concat(this.uuid)).hasClass("active") || (this.$materialSelect.trigger("close"), this.mainLabel.removeClass("active-check"))
                }
            }, {
    ...
    function(e, t) {
        ...
        function p(e, t) {
            function n(t) {
                g[h] = v + b * (t[l] - y), s(e, f), C(e), t.stopPropagation(), t.preventDefault()
            }
            ...
            S = {
                ...
                keyboard: function(e) {
                    ...
                    e.event.bind(e.ownerDocument, "keydown", function(i) {
                        if (!(i.isDefaultPrevented && i.isDefaultPrevented() || i.defaultPrevented) && (n() || r())) {
                            ...
                            e.settings.suppressScrollX && 0 !== s || e.settings.suppressScrollY && 0 !== a || (t.scrollTop -= a, t.scrollLeft += s, C(e), function(n, i) {
                ...
                wheel: function(t) {
                    ...
                    function i(e) {
                        ...
                        if (!n(e.target, o, s)) {
                            var a = !1;
                            t.settings.useBothWheelAxes ? t.scrollbarYActive && !t.scrollbarXActive ? (s ? r.scrollTop -= s * t.settings.wheelSpeed : r.scrollTop += o * t.settings.wheelSpeed, a = !0) : t.scrollbarXActive && !t.scrollbarYActive && (o ? r.scrollLeft += o * t.settings.wheelSpeed : r.scrollLeft -= s * t.settings.wheelSpeed, a = !0) : (r.scrollTop -= s * t.settings.wheelSpeed, r.scrollLeft += o * t.settings.wheelSpeed), C(t), (a = a || function(e, n) {
                                ...
                                for (var b = r, w = o; b < t.length; w += t[b].length, ++b) {
                                    ...
                                    if (!(_ instanceof l)) {
                                        if (g && b != t.length - 1) {
                                            ...
                                            for (var x = k.index + (p ? k[1].length : 0), C = k.index + k[0].length, S = b, T = w, E = t.length; S < E && (T < C || !t[S].type && !t[S - 1].greedy); ++S) x >= (T += t[S].length) && (++b, w = T);
                                        ...
                                        if (k) {
                                            ...
                                            C = (x = k.index + m) + (k = k[0].slice(m)).length;
                                            var A = _.slice(0, x),
                                                D = _.slice(C),
                                                P = [b, O];
                                            A && (++b, w += A.length, P.push(A));
                                            var N = new l(c, f ? n.tokenize(k, f) : k, v, k, g);
                                            if (P.push(N), D && P.push(D), Array.prototype.splice.apply(t, P), 1 != O && n.matchGrammar(e, t, i, b, w, !0, c), s) break
                                        } else if (s) break
                                    }
                                }
                            }
